    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
        ...
        >
          ...
          <div className="relative z-10">
            <span className="text-5xl mb-4 block">🏠</span>
            <h2 className="text-xl font-black text-foreground mb-2">부동산 추적기</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              관심 아파트 실거래가 모니터링
              <br />
              국토교통부 공공데이터 실시간 조회
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 rounded-full bg-secondary/15 text-secondary font-semibold">🏢 아파트</span>
              <span className="text-xs px-2 py-1 rounded-full bg-primary/15 text-primary font-semibold">📊 실거래가</span>
              <span className="text-xs px-2 py-1 rounded-full bg-money-in/15 text-money-in font-semibold">📈 시세</span>
            </div>
          </div>
        </button>
